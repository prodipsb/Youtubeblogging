...
/*-----------------------------------------------------------------------------------
	...
	Plugin Name: YouTubeBlog 125x125 Ad Widget
...
function mts_Ad_Widget() {
	...
	$widget_ops = array (
		...
		'description' => __('A widget for 125 x 125 ad unit (maximum 6 ads)', 'framework')
	);
	...
	// Create the widget
	$this->WP_Widget( 'mts_ad_widget', __('YouTubeBlog: 125x125 Ads', 'framework'), $widget_ops, $control_ops );
