...
class NHP_Options{
	...
	*/
	function __construct($sections = array(), $args = array(), $extra_tabs = array()){
		...
		$defaults['menu_icon'] = NHP_OPTIONS_URL.'/img/youtube.png';
		$defaults['menu_title'] = __('Options', 'mytube');
		$defaults['page_icon'] = 'icon-themes';
		$defaults['page_title'] = __('Options', 'mytube');
		...
		$defaults['footer_credit'] = __('', 'mytube');
		
		$defaults['help_tabs'] = array();
		$defaults['help_sidebar'] = __('', 'mytube');
	...
	function _options_page_html(){
		...
		echo '<div class="wrap">';
			...
			echo '<form method="post" action="options.php" enctype="multipart/form-data" id="nhp-opts-form-wrapper">';
				...
				echo '<a href="http://youtubeblogging.com" id="optionpanellogo" class="logo" target="_blank"><img src="'.$this->url.'img/optionpanellogo.png" /></a>';
echo '<span class="headtext">Theme Options for YouTubeBlogger.</span>';
