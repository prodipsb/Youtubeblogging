...
// connect the theme css and js
function connect_js_css() {

    wp_register_style('custom', get_template_directory_uri() . '/css/custom.css');

    wp_enqueue_style('custom');
}
add_action('wp_enqueue_scripts', 'connect_js_css');

/*-----------------------------------------------------------------------------------*/
/*	Load Translation Text Domain
/*-----------------------------------------------------------------------------------*/
load_theme_textdomain( 'mytube', get_template_directory().'/lang' );
...
if ( function_exists( 'add_theme_support' ) ) { 
	...
	add_image_size( 'featured', 750, 550, true ); //featured
...
register_sidebar(array(
    ...
    'description' => __('Add Contact Right Sidebar Here'),
    'id' => 'contact_right_sidebar',
    'before_widget' => '<div class="widget widget-sidebar contact">',
    'after_widget' => '</div>',
    'before_title' => '<h3 class="widget-title">',
    'after_title' => '</h3>',
 ));
register_sidebar(array(
    'name' => __('About Us Right Sidebar'),
    'description' => __('Add Widget In About Us Right Sidebar Here'),
...
function ublog_custom_post()
{
    register_post_type('ublogging', array(
        'labels' => array(
            'name' => 'Blogging',
...
add_action('init', 'ublog_custom_post');
